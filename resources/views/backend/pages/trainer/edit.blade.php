...
@section('title')
    {{ trans('trainer_trans.Edit_Trainer') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ trans('trainer_trans.Edit_Trainer') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#"
                        class="default-color">{{ trans('trainer_trans.Edit_Trainer') }}</a></li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.trainer.update',$trainer->id) }}"
                    autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="email" type="email" value="{{old('email',$trainer->email)}}">
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="birth_of_date" id="datepicker-action"
                                    data-date-format="yyyy-mm-dd" value="{{old('birth_of_date',$trainer->birth_of_date)}}">
                                @error('birth_of_date')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="subscription_number" type="number" value="{{old('subscription_number',$trainer->subscription_number)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="height" class="form-control" value="{{old('height',$trainer->height)}}">
                                @error('height')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="weight" class="form-control" value="{{old('weight',$trainer->weight)}}">
                                @error('weight')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="gender">
                                    ...
                                    <option value="male" @if(old('gender', $trainer->gender) == 'male') selected @endif>{{ trans('trainer_trans.Male') }}</option>
                                    <option value="female" @if(old('gender', $trainer->gender) == 'female') selected @endif>{{ trans('trainer_trans.Female') }}</option>
                                </select>
                                @error('gender')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{ trans('trainer_trans.Nationality') }}<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="nationality" class="form-control" value="{{old('nationality',$trainer->nationality)}}">
                                @error('nationality')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="salary" class="form-control" value="{{old('salary',$trainer->salary)}}">
                                @error('salary')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="gender"> {{ trans('trainer_trans.Address') }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="address" class="form-control" value="{{old('address',$trainer->address)}}">
                                @error('Editress')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-outline mb-4">
                                ...
                                <textarea name="trainer_bio" class="form-control" id="textAreaExample6" rows="3">
                                        {{old('trainer_bio',$trainer->trainer_bio)}}
                                </textarea>
                                @error('trainer_bio')
                    ...
                    <button type="submit" style="margin: 10px;"
                        class="btn btn-success btn-md  btn-lg">{{ trans('trainer_trans.Edit') }}</button>
