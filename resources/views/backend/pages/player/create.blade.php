...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0"> {{ trans('player_trans.Add_Player') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#"
                        class="default-color">{{ trans('player_trans.Add_Player') }}</a></li>
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ Route('backend.player.store') }}"
                    autocomplete="off">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="gender">
                                    ...
                                    <option value="male">{{ trans('player_trans.Male') }}</option>
                                    <option value="female">{{ trans('player_trans.Female') }}</option>
                                </select>
                                @error('gender')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="professionalism_degree">
                                    <option selected disabled>{{ trans('player_trans.Choose') }}</option>
                                    <option value="beginner">{{ trans('player_trans.Beginner') }}</option>
                                    <option value="intermediate">{{ trans('player_trans.Intermediate') }}</option>
                                    <option value="professional">{{ trans('player_trans.Professional') }}</option>
                                    <option value="very_professional">{{ trans('player_trans.Very_Professional') }}</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-outline mb-4">
                                ...
                                <textarea name="Player_bio" class="form-control" id="textAreaExample6" rows="3"></textarea>
                                @error('Player_bio')
                    ...
                    <button type="submit" style="margin: 10px;"
                        class="btn btn-success btn-md  btn-lg">{{ trans('player_trans.Add') }}</button>
